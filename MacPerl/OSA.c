...
XS(XS_MacPerl_Reply)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: MacPerl::Reply(reply)");
    {
	char *	reply = (char *)SvPV(ST(0),PL_na);
#line 101 "OSA.xs"
	{
#ifndef MACOS_TRADITIONAL
...
XS(XS_MacPerl_DoAppleScript)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: MacPerl::DoAppleScript(script)");
    {
	SV *	script = ST(0);
#line 116 "OSA.xs"
	{
...
XS(boot_OSA)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXS("MacPerl::Reply", XS_MacPerl_Reply, file);
        newXS("MacPerl::DoAppleScript", XS_MacPerl_DoAppleScript, file);
    XSRETURN_YES;
}
