...
#line 75 "Sound.xs"
	++sp;
	*sp = sv_newmortal();
	sv_setiv(*sp, (IV)(STRUCT.scChannelBusy));
		break;
	    case 4:	  /* scChannelDisposed */
#line 76 "Sound.xs"
	++sp;
	*sp = sv_newmortal();
	sv_setiv(*sp, (IV)(STRUCT.scChannelDisposed));
		break;
	    case 5:	  /* scChannelPaused */
#line 77 "Sound.xs"
	++sp;
	*sp = sv_newmortal();
	sv_setiv(*sp, (IV)(STRUCT.scChannelPaused));
		break;
	    case 6:	  /* scUnused */
#line 78 "Sound.xs"
	++sp;
	*sp = sv_newmortal();
	sv_setiv(*sp, (IV)(STRUCT.scUnused));
		break;
...
#line 74 "Sound.xs"
...

	{
	    ...
	    case 3:	  /* scChannelBusy */
#line 75 "Sound.xs"
	 STRUCT.scChannelBusy = (Boolean)SvIV( ST(1));
		break;
	    case 4:	  /* scChannelDisposed */
#line 76 "Sound.xs"
	 STRUCT.scChannelDisposed = (Boolean)SvIV( ST(1));
		break;
	    case 5:	  /* scChannelPaused */
#line 77 "Sound.xs"
	 STRUCT.scChannelPaused = (Boolean)SvIV( ST(1));
		break;
	    case 6:	  /* scUnused */
#line 78 "Sound.xs"
	 STRUCT.scUnused = (Boolean)SvIV( ST(1));
		break;
	    case 7:	  /* scChannelAttributes */
#line 79 "Sound.xs"
...
#line 89 "Sound.xs"
	++sp;
	*sp = sv_newmortal();
	sv_setpvn(*sp, (char *) &(STRUCT.format), 4);
		break;
...
#line 101 "Sound.xs"
	...
	if (sv_derived_from( ST(1), "Ptr")) {
	    ...
	    croak(" STRUCT.bufferPtr is not of type Ptr");
		break;
	    case 5:	  /* error */
#line 102 "Sound.xs"
...
XS(XS_Mac__Sound_SndDoCommand)
{
	...
	SndChannel	chan;
	SndCommand	cmd;
	Boolean	noWait = (Boolean)SvIV(ST(2));
	MacOSRet	RETVAL;
	dXSTARG;
	...
	if (sv_derived_from(ST(0), "SndChannel")) {
	    ...
	    croak("chan is not of type SndChannel");
...
XS(XS_Mac__Sound__SndPlay)
{
	...
	if (sv_derived_from(ST(1), "Handle")) {
	    ...
	    croak("sndHandle is not of type Handle");

	if (items < 3)
	    async = false;
	else {
	    async = (Boolean)SvIV(ST(2));
	}
#line 153 "Sound.xs"
...
XS(XS_Mac__Sound_SndStopFilePlay)
{
    ...
    {
	SndChannel	chan;
	Boolean	quietNow = (Boolean)SvIV(ST(1));
	MacOSRet	RETVAL;
	dXSTARG;
...
XS(XS_Mac__Sound_SetSoundPreference)
{
	...
	if (sv_derived_from(ST(2), "Handle")) {
	    ...
	    croak("settings is not of type Handle");
