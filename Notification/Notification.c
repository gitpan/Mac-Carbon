...
#line 46 "Notification.xs"
	...
	if (sv_derived_from( ST(0), "NMRec")) {
	    ...
	    croak(" STRUCT is not of type NMRec");
...
#line 63 "Notification.xs"
	...
	if (sv_derived_from( ST(1), "Handle")) {
	    ...
	    croak(" STRUCT->nmIcon is not of type Handle");
		break;
	    case 2:	  /* nmSound */
#line 64 "Notification.xs"
	 STRUCT->nmSound;
	...
	if (sv_derived_from( ST(1), "Handle")) {
	    ...
	    croak(" STRUCT->nmSound is not of type Handle");
		break;
	    case 3:	  /* nmStr */
#line 65 "Notification.xs"
...
XS(XS_NMRec_DESTROY)
{
	...
	if (SvROK(ST(0))) {
	    ...
	    croak("rec is not a reference");
#line 99 "Notification.xs"
	if (((PerlNMPtr)rec)->posted)
		NMRemove(rec);
	DisposePtr((Ptr)rec);
#line 196 "Notification.c"
    }
    XSRETURN_EMPTY;
}
...
XS(XS_Mac__Notification_NMInstall)
{
	...
	if (sv_derived_from(ST(0), "NMRec")) {
	    ...
	    croak("nmRequest is not of type NMRec");
